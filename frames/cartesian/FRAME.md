...
typography:
  # — reading ramp (Inter) —
  body:        { fontFamily: "JetBrains Mono", cqw: 1.0,  weight: 400, lineHeight: 1.6, color: "text-secondary" }
  body-sm:     { fontFamily: "JetBrains Mono", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:    { fontFamily: "JetBrains Mono", cqw: 1.3,  weight: 400, lineHeight: 1.5 }
  ...
  h3:          { fontFamily: "Archivo Black", cqw: 1.8, weight: 400, lineHeight: 1.1 }
  timeline-headline:{ fontFamily: "Archivo Black", cqw: 1.9, weight: 400, lineHeight: 1.1 }
  card-headline:{ fontFamily: "Archivo Black", cqw: 2.0, weight: 400, lineHeight: 1.15 }
  stat-figure: { fontFamily: "Archivo Black", cqw: 3.0, weight: 400, lineHeight: 1.0 }
  quote-mark:  { fontFamily: "Archivo Black", cqw: 9.0, weight: 400, lineHeight: 0.5, color: "line" }
  h2:          { fontFamily: "Archivo Black", cqw: 4.0, weight: 400, lineHeight: 1.1 }
  h1:          { fontFamily: "Archivo Black", cqw: 6.2, weight: 400, lineHeight: 1.06 }
  display:     { fontFamily: "Archivo Black", cqw: 8.0, weight: 400, lineHeight: 1.04 }

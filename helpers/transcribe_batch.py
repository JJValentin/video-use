...
Walks <videos_dir> for common video extensions, runs the configured
...
from transcribe import load_transcribe_config, transcribe_one
...
def main() -> None:
    ...
    print(
        f"transcribing {len(pending)} files with {args.workers} parallel workers "
